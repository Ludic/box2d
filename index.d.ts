...
//   (cfg?: Box2D.Box2DConfig): Promise<Box2D>
//   // [key: string]: any
// }
...
export function Box2D(cfg?: Box2D.Box2DConfig): Promise<(typeof Box2D) & ({[key: string]: any})>
// type Initializer = (cfg?: Box2D.Box2DConfig) => Promise<typeof Box2D>
